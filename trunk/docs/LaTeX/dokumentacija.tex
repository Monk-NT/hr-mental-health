...
\emph{Umjetne neuronske mreže} \engl{artifical neural networks} su mreže međusobno povezanih \emph{neurona}, nezavisnih isprogramiranih djelova koji obavljaju neku jednostavnu funkciju, da bi kao cjelina obavljali složeniju zadaću. Osnovni model umjetne neuronske mreže je perceptron \cite{rosenblatt-58}I OVA REFERENCA NE VALJA.
...
K-prolazna kros validacija \engl{K-fold cross validation} je tehinika korištena u strojnom učenju gdje se skup za treniranje podjeli na K nasumičnih skupova. Tada se treniranje vrši na $K-1$ skupova a jedan skup ostaje za validaciju dobivenog rezultata. Proces se ponavlja K puta tako da svaki put drugi skup bude izostavljen za validaciju. U ovom radu je korištena 10-prolazna kros validacija. Testiranje dobivenih modela je izvršeno na odvojenim skupovima za testiranje.
