...
\abstract{Poremećaji is baaaAAAD. Metode strojnog učenja primjenjive su na širok spektar problema iz različitih područja. Koristeći stroj s potpornim vektorima, stablo odluke, neuronsku mrežu i Bayesov ???? izgrađeni su klasifikatori tekstova autora s različitih psihičkim statusom. Rezultati.}
...
Funkcijske riječi \engl{function words} su zatvoreni razred neinfleksijskih riječi koje ne nose značajno značenje i vrše neku gramatičku funkciju. Takve riječi su u engleskom jeziku prilozi, prijedlozi, odrednice, veznici, modalni glagoli, pomoćni glagoli i čestice.
